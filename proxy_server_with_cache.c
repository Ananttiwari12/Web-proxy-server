...
// #include <ws2tcpip.h> // For IP and address conversion functions
// #include <windows.h>  // For other Windows APIs (optional if needed)
///////////////////////////////////////////////////////////////////////////////
...
// Define SHUT_RDWR if it's not available on Windows
#ifndef SHUT_RDWR
